...
import { LayoutDashboard, LogOut, User, Settings, FolderKanban, ShieldCheck, Gavel, Sun, Moon } from 'lucide-react';
...
const Layout = () => {
  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-[#030712] font-sans overflow-hidden transition-colors duration-300">
      ...
      <aside className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col transition-colors">
        ...
        <div className="p-6">
          <div className="flex items-center gap-3 text-indigo-600 dark:text-indigo-400">
            ...
            <h1 className="text-xl font-bold tracking-tight text-slate-850 dark:text-white">BidMaster</h1>
          </div>
        </div>
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-auto bg-slate-50 dark:bg-[#030712] transition-colors">
        <header className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md sticky top-0 z-10 border-b border-slate-200 dark:border-slate-800 px-8 py-4 flex justify-between items-center transition-colors">
